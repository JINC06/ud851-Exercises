...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "textLifecycle";
    ...
    // COMPLTED (2) Override onSaveInstanceState
    ...
    // COMPLTED (5) Put the text from the TextView in the outState bundle
